...
logs_dir_path = Path(f"/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/remeshing_nontop_array/logs")
...
def main():
    ...
    for model_dir in msh_dir_path.glob("model_*"):
        ...
        out_msh_path = model_dir / f"remeshing_nontop" / f"model_{model_id}_out.msh"
    ...
    # print output
    print()
    print(f"======= Remeshing Top Preserving Results ========")
