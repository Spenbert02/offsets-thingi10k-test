#!/bin/bash
#SBATCH --job-name=offsets_90979_1body
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
JSON_PATH="/scratch/seb9449/offsets_testing_thingi10k/tagged_tet_mshes/model_90979/singlebody/singlebody_90979_offset.json"
