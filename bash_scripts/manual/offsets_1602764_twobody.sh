#!/bin/bash
#SBATCH --job-name=offsets_1602764_2body
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
JSON_PATH="/scratch/seb9449/offsets_testing_thingi10k/tagged_tet_mshes/model_1602764/twobody/twobody_1602764_offset.json"
