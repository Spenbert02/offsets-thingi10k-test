...
run_list_fpath = f"/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/remeshing_nontop_array/pending_jobs.txt"
slurm_script_fpath = f"/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/remeshing_nontop_array/remeshing_nontop_submit_array.slurm"
logs_dir = f"/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/remeshing_nontop_array/logs"
...
def main():
    ...
    for i, subdir in enumerate(mesh_dir_path.glob("model_*")):
        ...
        output_msh_path = subdir / f"remeshing_nontop" / f"model_{model_id}_out.msh"
                ...
                with open(str(err_path), "r") as f:
                    ...
                    for line in lines:
                        ...
                        if "OOM Killed" in line:
                            ...
                            break
                    if include:
                        json_path = subdir / f"remeshing_nontop" / f"remeshing_nontop_{model_id}.json"
    ...
    print(f"Found {num_jobs} [remeshing_nontop] jobs to run")
