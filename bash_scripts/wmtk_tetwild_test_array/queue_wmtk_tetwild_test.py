...
run_list_fpath = f"/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/wmtk_tetwild_test_array/pending_jobs.txt"
slurm_script_fpath = f"/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/wmtk_tetwild_test_array/wmtk_tetwild_test_submit_array.slurm"
logs_dir = f"/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/wmtk_tetwild_test_array/logs"
...
def main():
    ...
    # collect jsons
    jsons_to_run = []
    def add_model_to_jsons(model_id_, subdir_):
        json_path = subdir_ / f"wmtk_tetwild_test" / f"wmtk_tetwild_test_{model_id_}.json"
    ...
    for i, subdir in enumerate(mesh_dir_path.glob("model_*")):
        ...
        output_msh_path = subdir / f"wmtk_tetwild_test" / f"model_{model_id}_out.msh"
    ...
    print(f"Found {num_jobs} [wmtk_tetwild_test] jobs to run")
