...
slurm_script_fpath = "/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/remeshing_test4_array/remeshing_test4_submit_array.slurm"
...
def main():
    ...
    for subdir in mesh_dir_path.glob("model_*"):
        ...
        if output_msh_path.exists() and (RUN_MODE != ALL):
            ...
            json_path = subdir / "remeshing_test4" / f"remeshing_test4_{model_id}.json"
