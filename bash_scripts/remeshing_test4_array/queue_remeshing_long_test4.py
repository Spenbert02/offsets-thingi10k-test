...
run_list_fpath = "/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/remeshing_test4_array/pending_jobs.txt"
slurm_script_fpath = "/scratch/seb9449/offsets_testing_thingi10k/offsets-thingi10k-test/bash_scripts/remeshing_test4_array/remeshing_test4_long_submit_array.slurm"
...
def main():
    ...
    for subdir in mesh_dir_path.glob("model_*"):
        ...
        output_msh_path = subdir / "remeshing_test4" / f"model_{model_id}_out.msh"
        if output_msh_path.exists() and (RUN_MODE != ALL):
            pass
        else:
            json_path = subdir / "remeshing_test4" / f"remeshing_test4_{model_id}_long.json"
    ...
    print(f"Found {num_jobs} [remeshing_test4] jobs to run")
